...
function [Selected_AFM_data,varargout]=A2_CleanUpData2_AFM(data,setpoints,secondMonitorMain,newFolder,varargin)
    ...
    % process further to save figures. If savFig is false, then not save. However, vertical distribution is
    % always plotted regardless the saveFig result. Therefore, the following line is outside the figure
    % processing
