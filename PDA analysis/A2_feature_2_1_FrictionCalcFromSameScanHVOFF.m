...
% This threshold is used as max acceptable difference between trace and retrace of vertical data      
    ...
    titleData2={sprintf("Lateral Force - %.2f%% of original dataset",percResidues);...
        sprintf("VD-4nN range (%.2f%%), LD outliers (%.2f%%), LD > setpoint+20%% (%.2f%%)",numRemovedElements_1,numRemovedElements_2,numRemovedElements_3)};
    titleData3="Lateral Force - raw";
    labelText="Force [nN]";
    showData(idxMon,true,vertForce_thirdClearing,titleData1,newFolder,nameFig,"labelBar",labelText,...
        "extraData",{force_thirdClearing,force},...
